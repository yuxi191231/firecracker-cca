...
use crate::vmm_config::cca_config::CCAConfig;
...
pub struct VmmConfig {
    ...
    #[serde(rename = "cca-config")]
    cca_config: Option<CCAConfig>,
}
...
impl VmResources {
    ...
    pub fn from_json(
        ...
        if let Some(cca_config) = vmm_config.cca_config {
            resources.cca = Some(cca_config);
        }
...
impl From<&VmResources> for VmmConfig {
    fn from(resources: &VmResources) -> Self {
        VmmConfig {
            ...
            cca_config: resources.cca.clone(),
        }
    }
}
